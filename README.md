...
```lua
loadstring(game:HttpGet("https://raw.githubusercontent.com/EcoTopWoods/cinematic-shader/v1.0.2/dist/loader.lua"))()
```

> Replace `EcoTopWoods` and the `v1.0.2` tag with your fork/release. The
...
```lua
loadstring(game:HttpGet("https://raw.githubusercontent.com/EcoTopWoods/cinematic-shader/v1.0.2/dist/cinematic.lua"))()
```
