...
```lua
loadstring(game:HttpGet("https://raw.githubusercontent.com/YOUR_GH_USERNAME/cinematic-shader/v1.0.0/dist/loader.lua"))()
```

> Replace `YOUR_GH_USERNAME` and the `v1.0.0` tag with your fork/release. The
...
```lua
loadstring(game:HttpGet("https://raw.githubusercontent.com/YOUR_GH_USERNAME/cinematic-shader/v1.0.0/dist/cinematic.lua"))()
```
